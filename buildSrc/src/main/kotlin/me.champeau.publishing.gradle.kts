...
fun MavenPom.addRequiredMetadataForPublicationOnMavenCentral() {
    ...
    url.set("https://github.com/melix/jlangdetect")
    licenses {
        license {
    ...
    scm {
        connection.set("scm:git:git://github.com/melix/jlangdetect.git")
        developerConnection.set("scm:git:ssh://github.com/melix/jlangdetect.git")
        url.set("https://github.com/melix/jlangdetect/tree/master")
    }
}
